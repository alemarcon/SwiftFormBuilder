...
public class VTRMessage {
    ...
    /// Message to show on dependency field validation error.
    private var _dependecyItemErrorMessage: String = "Il campo \(FIELD_NAME) deve essere valorizzato"
    ...
    private var _invalidPasswordErrorMessage: String = "Password non valida"
    ...
    public static var mandatoryErrorMessage: String {
        get {
    ...
    public static var stringValueNotFoundErrorMessage: String {
        get {
    ...
    /// Message to show on dependency field validation error. Default value is "Il campo $FIELD_NAME$ deve essere valorizzato". $FIELD_NAME$ will be replaced with dependency field title value.
    public static var dependecyItemErrorMessage: String {
        get {
            return shared._dependecyItemErrorMessage
        }
        set {
            shared._dependecyItemErrorMessage = newValue
        }
    }
    ...
    public static var dependecyUnmatchErrorMessage: String {
        get {
    ...
    public static var checkValueErrorMessage: String {
        get {
    ...
    public static var dependecyUnfilledErrorMessage: String {
        get {
    ...
    public static var invalidMailErrorMessage: String {
        get {
    ...
    public static var unmatchPasswordErrorMessage: String {
        get {
    ...
    public static var invalidPasswordErrorMessage: String {
        get {
    ...
    public static var invalidFiscalCodeErrorMessage: String {
        get {
    ...
    public static var invalidPhoneNumberErrorMessage: String {
        get {
